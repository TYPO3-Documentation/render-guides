...
use T3Docs\GuidesExtension\Renderer\Parallel\DocumentBatcher;
...
use T3Docs\GuidesExtension\Renderer\Parallel\ParallelTypeRenderer;
...
return static function (ContainerConfigurator $container): void {
    $container->services()
        ...
        // Parallel Rendering - Document batching and process management
        ->set(DocumentBatcher::class)
        ->set(ParallelTypeRenderer::class)
            ->arg('$sequentialRenderer', service(IncrementalTypeRenderer::class))
            ->arg('$cacheListener', service(IncrementalCacheListener::class))
            ->arg('$batcher', service(DocumentBatcher::class))
            ->arg('$logger', service('Psr\Log\LoggerInterface')->nullOnInvalid())
