...
final class DocumentNavigationProvider
{
     ...
     */
    public function getPreviousDocument(string $currentPath): ?DocumentNode
    {
        if (!$this->initialized) {
            return null;
        }
     ...
     */
    public function getNextDocument(string $currentPath): ?DocumentNode
    {
        if (!$this->initialized) {
            return null;
        }
     ...
     */
    public function getDocument(string $path): ?DocumentNode
    {
