...
final class CheckHeadlineAnchorsFieldListItemRule implements FieldListItemRule
{
    public function applies(FieldListItemNode $fieldListItemNode): bool
    {
        return strtolower($fieldListItemNode->getTerm()) === 'check-headline-anchors';
    }

    public function apply(FieldListItemNode $fieldListItemNode, BlockContext $blockContext): MetadataNode
    {
        return new CheckHeadlineAnchorsNode($fieldListItemNode->getPlaintextContent());
    }
}
