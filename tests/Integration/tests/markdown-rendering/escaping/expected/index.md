...
# Markdown escaping of text {#markdown-escaping-of-text}
...
## Emphasis characters {#emphasis-characters}
...
## Block markers at the start of a line {#block-markers-at-the-start-of-a-line}
...
## Inside code spans {#inside-code-spans}
